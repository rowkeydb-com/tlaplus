...
public interface IStateQueue {
  ...
  /**
   * Cleans up old state pools after a successful checkpoint.
   * This method should ONLY be called by ModelChecker after the
   * `commit.inprogress` marker is successfully deleted.
   */
  public abstract void vacuum() throws IOException;
